...
1. attendment: representa um atendimento/e  um chat id (1:1 Sempre ?) (estado de vida: início, reatribuições, encerramento).
2. attendment_ai_interaction: representa eventos do agente/IA dentro do atendimento (respostas de modelo, ações internas** e chamadas de ferramentas).
(3. attendment_tracelog)
...
```
## 2. Tabela attendment_ai_interaction (hoje já tem uma função que faz isso )
